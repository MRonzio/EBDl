...
def dloptions():
    ...
    parser.add_argument('-o', '--organism', dest='organism', default='Homo sapiens', help='organism, e.g. \"Homo sapiens\". NOTE the quotes')
    ...
    parser.add_argument('-e', '--exp-type', dest='assay', required=True, help='experiment type or assay: either "TF" or "Histone"')
    parser.add_argument('-f', '--factor', dest='trg', default='*', help='target name')
